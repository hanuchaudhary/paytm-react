...
const SendMoney = () => {
  ...
  return (
    <div className="min-h-screen bg-black bg-opacity-70 text-white flex items-center justify-center">
      <div className="relative border-2 w-[80%] md:w-1/2 border-neutral-700 bg-neutral-800 p-6 rounded-none shadow-md">
        <div className="flex items-center justify-center mb-10">
          <h1 className="text-2xl font-semibold">Send Money</h1>
        </div>
        <div className="flex items-center mb-6">
          <div className="bg-neutral-600 text-white h-12 w-12 flex items-center justify-center rounded-full mr-4">
            {/* {name.charAt(0)} */}
          </div>
          <div>
