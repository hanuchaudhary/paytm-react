        ...
        <div className="bg-white dark:bg-neutral-800 transition-colors duration-500 rounded-2xl md:p-6 sm:p-4 p-3 shadow-lg md:mb-12 mb-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <motion.button
              ...
              className="px-4 py-2 dark:bg-neutral-200 dark:border-neutral-600 dark:text-black text-white border-neutral-600 bg-neutral-900 font-semibold rounded-lg text-xs md:text-base transition-colors duration-300"
              aria-label={
