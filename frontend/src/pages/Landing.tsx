...
const subHeading = [
  ...
  },
  {
    text: "PayEase",
    className:
      "text-blue-500 dark:text-blue-500 text-base md:text-lg font-normal tracking-tight leading-none",
  },
  {
    text: "today",
    className: "text-base md:text-lg font-normal tracking-tight leading-none",
    ...
    <div>
      <div className="min-h-screen overflow-hidden relative transition-colors duration-500 bg-neutral-100 dark:bg-black text-neutral-900 dark:text-neutral-100 font-sans">
        ...
        <div className="max-w-4xl mx-auto pb-40">
          <div className="lg:pt-40 pt-40">
            <TextGenerateEffect
              ...
              className="bg-gradient-to-r text-4xl md:text-8xl from-blue-500 dark:to-white to-blue-800 text-transparent bg-clip-text text-center"
            />
          </div>
        ...
        <main>
          <section
            id="features"
            className="md:py-20 bg-neutral-100 transition-colors duration-500 dark:bg-black"
          >
