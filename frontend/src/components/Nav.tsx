...
const Nav = () => {
  ...
  return (
    <div className="w-full flex justify-center relative overflow-hidden">
      <header className="fixed w-[95%] top-4 border shadow-lg shadow-neutral-600/5 backdrop-blur-lg z-[100] dark:border-neutral-800 dark:bg-opacity-55 dark:backdrop-filter dark:backdrop-blur-md backdrop-filter bg-opacity-55 border-neutral-200 rounded-xl bg-neutral-300 dark:bg-neutral-800 py-5 mx-auto">
